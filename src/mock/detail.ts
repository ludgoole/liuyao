export default {
  ...
  爻位: {
    初爻: '起始阶段、内核、隐藏、室内、北面、乡下、底层、地下、下肢、床',
    二爻: '初步阶段、门户、邻近、本地、内部、下腹、中下层、刚出发',
    三爻: '逾半、内部外缘、周边、腰腹部、适中、中间、中层、不远不近',
    四爻: '过半、外部内缘、途中、背腹部、适中、中间、中层、不远不近',
    五爻: '路上、关键、权威、至尊、心念、偏高处、较远、胸部、接近终点',
    上爻: '外表、终点、结局、南面、上层、顶部、头颈、远方、外地、退休',
    用神: '所测的事情',
    世爻: '自己 出生地 单位 城市 喜好',
    应爻: '他人 对手 情敌',
  ...
  六亲: {
    兄弟: '同辈、伙伴、同学、同事、竞争者、被动、受制、损耗、破费、风',
    妻财: '妻子、女友、情人、保姆、员工、资金、珠宝、生意、买卖、套现、食物、餐厅、亚健康，多云',
    子孙: '晚辈、徒弟、娱乐、游玩、辞职、药物、医生、警察、士兵、良将、僧道、动物，家禽、放松、解忧、晴朗',
    官鬼: '丈夫、官府、官司、诉讼、功名、事业、成就、荣誉、上司、贵人、鬼神、邪祟、盗贼、敌对、祸患、担忧、疾病、厌恶、虚假、雷电、冷门',
    父母: '长辈、师傅、老板、股东、靠山、城市、房屋、床柜、衣服、布匹、雨具、车船、工程、投标、合同、证件、票据、账目、文书、电话、学校、学业、奖状、下雨',
  },
  六神: {
    青龙: '骨架、喜庆、色情、无私、清白、正直、高大、体面、清高、崭新、左面',
    朱雀: '发热、炎症、争讼、投诉、打听、言谈、标识、广告、热闹、文书、前面',
    勾陈: '堆积、凝结、土地、老实、木讷、肥胖、牢狱、外表、陈旧、历史、居中',
    螣蛇: '筋络、恐惧、惊怕、忐忑、担忧、风险、弯曲、空管、阴暗、内在、通道',
    白虎: '血液、灾祸、哀怨、不满、疾病、权威、死丧、粗鲁、强硬、破旧、右面',
    玄武: '呼吸、隐私、隐瞒、藏匿、负面、偷盗、主观、细微、小人、难测、后面',
  },
  因缘: {
